    ...
    return (
        <div className="p-4 flex justify-between border-b border-solid border-gray-400">
            <div className="flex items-center space-x-24">
                <Auth0Logo />
                <input
                    className="w-64 bg-gray-200 rounded leading-normal"
                    type="search"
            ...
            <div className="flex items-center space-x-4">
                ...
                <button>Docs</button>
                <button className="p-1 border border-solid border-black rounded-md">
                    Discuss Your Needs
                </button>
                <button className="flex items-center">
                    <span className="mr-1">Maurice Le Cordier</span>
