...
const VercelLogo = ({ className }) => {
  return (
    <svg
      className={className}
      width="116" height="100" viewBox="0 0 116 100" fill="#000" xmlns="http://www.w3.org/2000/svg">
        ...
        <header>
          <nav className="max-w-5xl mx-auto pt-5 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="inline-flex items-center space-x-2 leading-5 font-medium">
                ...
                <button type="button" className="inline-flex items-center border border-transparent rounded-sm p-1 hover:border-gray-200 hover:bg-gray-100 transition ease-in-out duration-300">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-5">
                ...
                <button type="button" className="border rounded-md border-gray-200 text-sm leading-5 text-gray-600 px-3 py-1 hover:border-black transition ease-in-out duration-150">
                  Feedback
            </button>
                <Link href="#">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <nav className="flex space-x-5 text-sm leading-5">
              ...
              <Link href="#">
                <a className="py-4 px-1 border-b-2 border-transparent text-gray-500">
                  Projects
              </a>
              </Link>
              <Link href="#">
